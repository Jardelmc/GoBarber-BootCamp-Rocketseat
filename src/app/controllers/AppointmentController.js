  ...
  async delete(req, res) {
    const appointment = await Appointment.findByPk(req.params.id, {
      include: [
        {
          model: User,
          as: 'provider', // Nickname dado no relacionamento no Model
    ...
    appointment.canceled_at = new Date(); // Se o campo canceled_ad não estiver null, significa que o agendamento foi cancelado
